...
from POLICE_STATION PS
    inner join EVACUATION_FACILITY EF
...
from EVACUATION_FACILITY EF
    inner join        
        (select
            ...
            count(*) as NO
        from POLICE_STATION PS
            left join EVACUATION_FACILITY EF
                on PS.POLICE_NO = EF.POLICE_STATION
                where EF.FACILITY_CAPACITY > '1000'
